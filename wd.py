...
from wd.utils.utilities import update_collection, load_yaml
...
if __name__ == '__main__':
    ...
    if action == "resume_run":
        from wd.experiment.resume import resume_set_of_runs
        ...
        from wd.experiment.resume import complete_incompleted_runs
        param_path = args.file or 'resume.yaml'
        settings = load_yaml(param_path)
